...
// Mock @/lib/supabase globally so modules that import it during initialization
// (like useAuth.tsx) don't fail with "supabaseUrl is required".
...
// MSW — start once, reset between tests, close after all
